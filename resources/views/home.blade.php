                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <span
                                style="font-size:1.5rem;font-weight: 900; color: #ffc107">{{Auth()->user()->Bookings->where('status',0)->count()}}</span>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <span
                                style="font-size:1.5rem;font-weight: 900; color:#28a745">{{Auth()->user()->Bookings->where('status',1)->count()}}</span>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <span
                                style="font-size:1.5rem;font-weight: 900; color: #dc3545;">{{Auth()->user()->Bookings->where('status',2)->count()}}</span>
                        </div>
