...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office"
      style="width:100%;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0" dir="ltr">
<head>
    ...
    <meta property="og:title" content="Trigger newsletter 3"/>
    <meta property="og:description"
          content="Put your preheader text here View in browser Beretun Shop Thank You For Your Order! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium iste i"/>
    <meta property="og:url" content="https://viewstripo.email/template/974d2c95-ae4e-4a55-ad78-4edcca712d2b"/>
                    ...
                    <tr style="border-collapse:collapse">
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-header-body"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#C22626;width:600px"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="left"
                                                                    style="padding:0;Margin:0"><h1
                                                                        ...
                                                                        {{App\User::find($data->user_id)->name}}</h1></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </td>
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        ...
                                                                        <td style="padding:5px 0;Margin:0" width="20%"
                                                                            align="left">
                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333">
                                                                                                              {{$data->bookable_type::find($data->bookable_id)->title}}
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    @if($data->asi != null )
                                                                    @foreach(json_decode($data->asi) as $key => $value)
...
{{--                                                        <tr style="border-collapse:collapse">--}}
{{--                                                            <td align="center"--}}
{{--                                                                style="padding:0;Margin:0;padding-top:25px"><h2--}}
...
{{--                                                                    Get 25% off your next order.</h2></td>--}}
{{--                                                        </tr>--}}
{{--                                                        <tr style="border-collapse:collapse">--}}
{{--                                                            <td align="center"--}}
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:530px">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td esdev-links-color="#777777" align="left"
                                                                class="es-m-txt-c"
                                                                style="padding:0;Margin:0;padding-bottom:5px"><p
                                                                    ...
                                                                    address, please ignore this email or&nbsp;<u><a
                                                                            ...
                                                                            class="unsubscribe" href="">unsubscribe</a></u>.
                                                                </p></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
